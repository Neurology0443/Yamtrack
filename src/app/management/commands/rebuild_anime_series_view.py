"""Rebuild persisted MAL anime series-view projections."""
...
class Command(BaseCommand):
    """Rebuild series-view projections for existing tracked MAL anime."""
    ...
    def handle(self, *_args, **options):
        """Run canonical rebuilds for the selected users."""
        ...
        for user in users:
            media_ids = requested_media_ids or set(
            ...
            totals["users"] += 1
            totals["roots"] += stats.canonical_roots_refreshed
            ...
            self.style.SUCCESS(
                " | ".join(
                    [
                        ...
                        f"canonical_roots={totals['roots']}",
