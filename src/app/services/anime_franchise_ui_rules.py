"""UI-specific section classification rules for MAL anime franchise grouping."""
...
SECTION_RULES = [
    # NOTE: some include/exclude pairs are intentionally explicit even when one side
    # may look redundant; this keeps rule intent obvious during future tuning.
    AnimeFranchiseSectionRule(
        key="ignored",
        title="Ignored",
        visible_in_ui=False,
...
def get_section_rules() -> list[AnimeFranchiseSectionRule]:
    """Return sorted UI section rules evaluated by priority."""
