...
class AnimeLayoutChoices(models.TextChoices):
    """Choices for anime media list layout options."""

    GRID = LayoutChoices.GRID.value, LayoutChoices.GRID.label
    TABLE = LayoutChoices.TABLE.value, LayoutChoices.TABLE.label
